...
## Analysis
Analyzing all repository sources for Accessibility Checks patterns...
...
## Purpose
Define WCAG-oriented checks for focus, keyboard, labels, contrast, reduced motion, forms, dialogs, and responsive states.
...
`json
{
  ...
  "cross_folder_dependencies": ["ui/accessibility.md; ux/states.md"],
  "interfaces": {
    "json_schema": {},
...
- Before executing this, ensure ui/accessibility.md; ux/states.md is reviewed for compatibility.
...
- ui/accessibility.md; ux/states.md

<!-- QA-INTERNET-TUNED-RATIONALIZATION-2026-05-10 -->

## QA Rationalization And Verification Layer

Analyzing all repository sources for QA rationalization patterns... This file remains the specialist accessibility gate under the canonical `qa-and-checks/` release surface. Before executing this, ensure `qa-and-checks/README.md`, `checklist.md`, `ui/accessibility.md`, `ux/states.md`, and relevant frontend/UI files are reviewed for compatibility.

WCAG 2.2 gate additions: keyboard access, no keyboard traps, focus visible and not obscured, target size, label-in-name, name/role/value, status messages, error identification, error suggestion, reduced-motion behavior, accessible authentication, and responsive reflow.
