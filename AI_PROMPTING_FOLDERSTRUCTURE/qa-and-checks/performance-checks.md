...
## Analysis
Analyzing all repository sources for Performance Checks patterns...
...
## Persona
Act as a senior Performance QA owner with 15+ years of production experience. You are accountable for business behavior, technical correctness, accessibility, security, performance, observability, and QA handoff.

## Purpose
Define Core Web Vitals, API latency, DB query budgets, caching, bundle size, timeout caps, and load checks.
...
`json
{
  ...
  "cross_folder_dependencies": ["database/performance.md; frontend/tests.md"],
  "interfaces": {
    "json_schema": {},
...
- Before executing this, ensure database/performance.md; frontend/tests.md is reviewed for compatibility.
...
- database/performance.md; frontend/tests.md

<!-- QA-INTERNET-TUNED-RATIONALIZATION-2026-05-10 -->

## QA Rationalization And Verification Layer

Analyzing all repository sources for QA rationalization patterns... This file remains the specialist performance gate under the canonical `qa-and-checks/` release surface. Before executing this, ensure `qa-and-checks/README.md`, `checklist.md`, `database/performance.md`, `frontend/tests.md`, `integration/error-handling.md`, and `scripts/ci-cd-pipeline.md` are reviewed for compatibility.

Core Web Vitals additions: define and verify LCP, INP, CLS, and TTFB expectations when user-facing. Also name bundle-size, render-blocking, API latency, database query, third-party timeout, cache freshness, and degradation budgets.
