...
## Mission
This artifact extends the Product-Engineering OS with a deeper operating capability for Architecture. It is created in append-only, non-regression mode and must be read as an additional layer on top of ai_dev_system.md, SYSTEM.md, repository_source_inventory.md, and the local folder instructions.

## Analysis
Analyzing all repository sources for Interface Contract Registry patterns...
...
## Purpose
Define how JSON schemas, React props, API envelopes, event payloads, DB invariants, and prompt metadata contracts are registered and cross-linked.

## Persona
Act as a principal Architecture architect with 15+ years of production experience. You are responsible for turning repository memory into production-ready assets, preserving existing behavior, and creating QA-verifiable handoffs.
...
6. backend/prompt_template_backend_api.md; frontend/component_template.md; database/schema-rules.md

## Input Contract
~~~json
{
  "task_id": "string",
  "artifact": "Interface Contract Registry",
  "domain": "Architecture",
  ...
  "cross_links_reviewed": ["backend/prompt_template_backend_api.md; frontend/component_template.md; database/schema-rules.md"],
  "interfaces": {
    "json_schema": {},
...
Before executing this, ensure these files are reviewed for compatibility: backend/prompt_template_backend_api.md; frontend/component_template.md; database/schema-rules.md.
