...
## Analysis
Analyzing all repository sources for Sample Regression Matrix patterns...
...
## Purpose
Provide a concrete non-regression matrix sample for routes, permissions, data mutations, UI states, integrations, and rollback evidence.
...
6. docs/non-regression-matrix.md; qa-and-checks/checklist.md

## Input Contract
~~~json
{
  "task_id": "string",
  "artifact": "Sample Regression Matrix",
  "domain": "Samples",
  ...
  "cross_links_reviewed": ["docs/non-regression-matrix.md; qa-and-checks/checklist.md"],
  "interfaces": {
    "json_schema": {},
...
Before executing this, ensure these files are reviewed for compatibility: docs/non-regression-matrix.md; qa-and-checks/checklist.md.
