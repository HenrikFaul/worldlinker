...
## Analysis
Analyzing all repository sources for AI Delegation Protocol patterns...
...
## Purpose
Define how conceptual agents delegate work across DB, Backend, Integration, Frontend, UI, UX, QA, docs, scripts, and governance owners.
...
6. .ai/agents.md; .ai/skills.md; ai_dev_system.md

## Input Contract
~~~json
{
  "task_id": "string",
  "artifact": "AI Delegation Protocol",
  ...
  "cross_links_reviewed": [".ai/agents.md; .ai/skills.md; ai_dev_system.md"],
  "interfaces": {
    "json_schema": {},
...
Before executing this, ensure these files are reviewed for compatibility: .ai/agents.md; .ai/skills.md; ai_dev_system.md.
