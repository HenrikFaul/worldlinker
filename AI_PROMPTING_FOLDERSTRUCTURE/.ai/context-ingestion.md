...
## Mission
This artifact extends the Product-Engineering OS with a deeper operating capability for AI Orchestration. It is created in append-only, non-regression mode and must be read as an additional layer on top of ai_dev_system.md, SYSTEM.md, repository_source_inventory.md, and the local folder instructions.

## Analysis
Analyzing all repository sources for Context Ingestion Protocol patterns...
...
## Purpose
Define the exact process for scanning repository files, classifying source classes, refreshing inventory, and producing source-backed outputs.

## Persona
Act as a principal AI Orchestration architect with 15+ years of production experience. You are responsible for turning repository memory into production-ready assets, preserving existing behavior, and creating QA-verifiable handoffs.
...
6. docs/repository_source_inventory.md; .ai/best-practices.md

## Input Contract
~~~json
{
  "task_id": "string",
  "artifact": "Context Ingestion Protocol",
  ...
  "cross_links_reviewed": ["docs/repository_source_inventory.md; .ai/best-practices.md"],
  "interfaces": {
    "json_schema": {},
...
Before executing this, ensure these files are reviewed for compatibility: docs/repository_source_inventory.md; .ai/best-practices.md.
