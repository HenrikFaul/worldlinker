...
## Analysis
Analyzing all repository sources for AI Skills Matrix patterns...
...
## Purpose
Map each agent role to skills, source files, verification obligations, and escalation boundaries.
...
`json
{
  ...
  "cross_folder_dependencies": [".ai/agents.md; docs/repository_source_inventory.md"],
  "interfaces": {
    "json_schema": {},
...
- Before executing this, ensure .ai/agents.md; docs/repository_source_inventory.md is reviewed for compatibility.
...
- .ai/agents.md; docs/repository_source_inventory.md
